...
import { createServerSupabaseClient, authorizedAction } from '@/lib/auth'
import { StrokeConfig } from '@/util/constants'

interface ClaimSignatureParams {
  name: string
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    const { name, signaturePath, strokeConfig, includeNumbers } = req.body as ClaimSignatureParams
